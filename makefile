...
INCLUDE = -I=${GOPATH}/src/github.com/mydexchain/tm-db -I=${GOPATH}/src -I=${GOPATH}/src/github.com/gogo/protobuf/protobuf
...
gen_certs: clean_certs
	...
	certstrap sign "remotedb" --CA "mydexchain.com" --passphrase ""
